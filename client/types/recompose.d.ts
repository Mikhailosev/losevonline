...
declare module 'recompose' {
  ...
  export function mapProps<TInner, TOutter>(propsMapper: mapper<TOutter, TInner>): InferableComponentEnhancerWithProps<TInner, TOutter>
  ...
  type stateProps<TState, TStateName extends string, TStateUpdaterName extends string> = { [stateName in TStateName]: TState } &
  ...
  type reducerProps<TState, TAction, TStateName extends string, TDispatchName extends string> = { [stateName in TStateName]: TState } &
  ...
  type ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance = {}> = _ReactLifeCycleFunctionsThisArguments<TProps, TState> &
    TInstance
  ...
  interface ReactLifeCycleFunctions<TProps, TState, TInstance = {}> {
    ...
    shouldComponentUpdate?:
      | ((this: ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance>, nextProps: TProps, nextState: TState) => boolean)
      | undefined
    componentWillUpdate?:
      | ((this: ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance>, nextProps: TProps, nextState: TState) => void)
      | undefined
    ...
    componentDidUpdate?:
      | ((this: ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance>, prevProps: TProps, prevState: TState) => void)
      | undefined
    componentWillUnmount?: ((this: ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance>) => void) | undefined
    componentDidCatch?:
      | ((this: ReactLifeCycleFunctionsThisArguments<TProps, TState, TInstance>, error: Error, info: React.ErrorInfo) => void)
      | undefined
  }
  ...
  export function createEagerElement(type: Component<any> | string, props?: Object, children?: React.ReactNode): React.ReactElement
  ...
  export function mapPropsStreamWithConfig(
    config: ObservableConfig
  ): <TInner, TOutter>(transform: mapper<Subscribable<TOutter>, Subscribable<TInner>>) => ComponentEnhancer<TInner, TOutter>
  ...
  export function createEventHandlerWithConfig(config: ObservableConfig): <T, TSubs extends Subscribable<T>>() => EventHandlerOf<T, TSubs>
